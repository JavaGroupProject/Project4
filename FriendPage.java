...
public class FriendList extends JPanel implements MyQuestion {
...
//		JPanel controlPanel = new JPanel(new BorderLayout());
	    ...
	    try{
	    	//add image button #1
	    	button = ImageIO.read(new File("/Users/gerrythiers/Pictures/frat1.jpg"));
	    	friendImage1 = button.getScaledInstance(100, 200, java.awt.Image.SCALE_SMOOTH);
	    	...
	    	//add image button #2
	    	button = ImageIO.read(new File("/Users/gerrythiers/Pictures/frat1.jpg"));
	    	friendImage2 = button.getScaledInstance(100, 200, java.awt.Image.SCALE_SMOOTH);
	    	...
	    	//add image button #3
	    	button = ImageIO.read(new File("/Users/gerrythiers/Pictures/frat1.jpg"));
	    	friendImage3 = button.getScaledInstance(100, 200, java.awt.Image.SCALE_SMOOTH);
	    	...
	    	//add image button #4
	    	button = ImageIO.read(new File("/Users/gerrythiers/Pictures/frat1.jpg"));
	    	friendImage4 = button.getScaledInstance(100, 200, java.awt.Image.SCALE_SMOOTH);	    	
	    	...
	    	//add image button #5
	    	button = ImageIO.read(new File("/Users/gerrythiers/Pictures/frat1.jpg"));
	    	friendImage5 = button.getScaledInstance(100, 200, java.awt.Image.SCALE_SMOOTH);	    	
	    	...
	    	//add image button #6
	    	button = ImageIO.read(new File("/Users/gerrythiers/Pictures/frat1.jpg"));
	    	friendImage6 = button.getScaledInstance(100, 200, java.awt.Image.SCALE_SMOOTH);  	
